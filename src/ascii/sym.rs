    ...
    fn from(val: &SymbolType) -> Self {
        match val{
            ...
            SymbolType::Relation(rel) => match rel {
                ...
                Relation::MuchLess => "&Lt;",
                Relation::MuchGreater => "&Gt;",
                Relation::Prec => "&#x227A;",
                Relation::PrecEq => "&#x2AAF;",
                Relation::Succ => "&#x227B;",
                Relation::SuccEq => "&#x2AB0;",
            ...
            SymbolType::Misc(misc) => match misc{
                MiscOperator::Integral => "&int;",
                MiscOperator::OIntegral => "&conint;",
                MiscOperator::Partial => "&part;",
                MiscOperator::Nabla => "&nabla;",
                MiscOperator::PlusMinus => "&plusmn;",
                MiscOperator::EmptySet => "&empty;",
                MiscOperator::Infinity => "&infin;",
                MiscOperator::Aleph => "&#x2135;",
                MiscOperator::Therefore => "&there4;",
                MiscOperator::Because => "&because;",
                MiscOperator::Dots => "...",
                MiscOperator::Cdots => "&#x22EF;",
                MiscOperator::Vdots => "&#x22EE;",
                MiscOperator::Ddots => "&#x22F1;",
                MiscOperator::Whitespace => "&#xA0;",
                MiscOperator::Whitequad => "&#xA0;&#xA0;",
                MiscOperator::Angle => "&ang;",
                MiscOperator::Frown => "&#x2322;",
                MiscOperator::Triangle => "&#x25B3;",
                MiscOperator::Diamond => "&diamond;",
                MiscOperator::Square => "&#x25A1;",
                MiscOperator::Complex => "&#x2102;",
                MiscOperator::Natural => "&#x2115;",
                MiscOperator::Rational => "&#x211A;",
                MiscOperator::Real => "&#x211D;",
                MiscOperator::Whole => "&#x2124;",
            }.into(),
